...
class InstagramRobot:
    ...
    def unfollow(self, username):
        ...
        unfollow_button = self.driver.fin_element_by_xpath('//*[@id="react-root"]/section/main/div/header/section/div[2]/div[2]/span/span[1]/button/div/span')
        print(unfollow_button)
        unfollow_button.click()
        # 						     //*[@id="react-root"]/section/main/div/header/section/div[2]/div[2]/span/span[1]/button
